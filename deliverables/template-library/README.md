# DRIVE Template Library

Use this folder as the single staff-download location.

| Template | Use it for |
|---|---|
| `DRIVE_Integrated_Technical_Design_Template.docx` | Overall enhancement document: business purpose, business logic, component-document register, Coat flow, final output and release evidence. |
| `DA_Data_Architecture_Design_Template.docx` | Global EDI Gold View source, Refined Coat / Sealer Coat manipulation process, programs/tools and RC/SC objects. |
